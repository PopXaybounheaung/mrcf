// src/components/WaterLevelChart.vue
<template>
  <div class="chart-container">
    <div class="header-container" style="display: flex; align-items: center; justify-content: center; gap: 12px;">
      <svg width="50px" height="50px" viewBox="0 0 32 32" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;" 
...
export default {
  ...
  data() {
    return {
      ...
      mockLevels: Array.from({ length: 24 }, (_, i) => ({
        time: i,
...
const updateChartData = async () => {
    try {
        const data = await firebaseService.getStationHistory('STATION1', 24);
